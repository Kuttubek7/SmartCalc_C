...
START_TEST(s21_check_input) {
  ...
  char string_21[] = "()";
  err = check_input(string_21);
  ck_assert_int_eq(2, err);

  char string_22[] = "hello";
  err = check_input(string_22);
  ck_assert_int_eq(1, err);

  char string_23[] = "2*2/4";
  err = check_input(string_23);
  ck_assert_int_eq(0, err);
}
END_TEST
...
START_TEST(calculator) {
  ...
  char input_18[] = "hello";
  int err = check_input(input_18);
  if (err == 0) {
    Node *number_list = parsing(input_18);
    number_list = polish_notation(number_list, 0);
    res_21 = calculation(number_list);
  }
  ck_assert_int_eq(1, err);
  ...
  err = check_input(input_19);
  if (err == 0) {
    Node *number_list = parsing(input_19);
    number_list = polish_notation(number_list, 0);
    res_21 = calculation(number_list);
  }
  ck_assert_int_eq(1, err);
  ...
  err = check_input(input_20);
  if (err == 0) {
    Node *number_list = parsing(input_20);
    number_list = polish_notation(number_list, 0);
    res_21 = calculation(number_list);
  }
  ck_assert_int_eq(3, err);
  ...
  err = check_input(input_21);
  if (err == 0) {
    Node *number_list = parsing(input_21);
    number_list = polish_notation(number_list, 0);
    res_21 = calculation(number_list);
  }
  ck_assert_int_eq(2, err);
  ...
  if (err == 0) {
    Node *number_list = parsing(input_23);
    number_list = polish_notation(number_list, 0);
    res_21 = calculation(number_list);
  }
  ck_assert_int_eq(0, err);
